<?php
// Incluir encabezados o configuración de PHP, si es necesario
// Por ejemplo, puedes incluir un archivo de configuración o autenticación si es necesario.
// include('config.php');
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
    <meta charset="utf-8">
    <title>HairCut - Plantilla HTML para Salón de Peluquería</title>
...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="team.php" class="dropdown-item">Nuestro Barbero</a>
                        <a href="open.php" class="dropdown-item">Horas de Trabajo</a>
                        <a href="testimonial.php" class="dropdown-item">Testimonios</a>
                        <a href="404.php" class="dropdown-item active">Página 404</a>
                    </div>
                </div>
                <a href="contact.php" class="nav-item nav-link">Contacto</a>
            </div>
            <a href="" class="btn btn-primary rounded-0 py-2 px-lg-4 d-none d-lg-block">Cita<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white text-uppercase mb-3 animated slideInDown">Error 404</h1>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <h4 class="text-uppercase mb-4">Ponte en Contacto</h4>
                    <div class="d-flex align-items-center mb-2">
                        <div class="btn-square bg-dark flex-shrink-0 me-3">
                            <span class="fa fa-map-marker-alt text-primary"></span>
                        </div>
                        <span>123 Calle, Nueva York, USA</span>
                    </div>
                    <div class="d-flex align-items-center mb-2">
                        <div class="btn-square bg-dark flex-shrink-0 me-3">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <a class="btn btn-link" href="contact.php">Contáctanos</a>
                    <a class="btn btn-link" href="service.php">Nuestros Servicios</a>
                    <a class="btn btn-link" href="terms.php">Términos y Condiciones</a>
                    <a class="btn btn-link" href="support.php">Soporte</a>
                </div>
                <div class="col-lg-4 col-md-6">
                    <h4 class="text-uppercase mb-4">Boletín de Noticias</h4>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Nombre de tu sitio</a>, Todos los derechos reservados.
                    </div>
